...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden text-center">
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      >
        ...
        >
          <h1 className="font-syne text-2xl font-bold mb-1">Create your account</h1>
          <p className="text-muted text-sm mb-7">Free to start — no credit card needed</p>
