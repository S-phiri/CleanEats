...
- Design the 7-day meal plan so it is realistic to prep within this window: favour batch components, make-ahead breakfasts (e.g. overnight oats), and repeated proteins/grains where it fits the user's cook time and goal.
