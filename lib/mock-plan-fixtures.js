...
/** Extra ZM library meals for cache days 6–7 (seeded via scripts/seed-meals-library.js). */
function buildZmLibrarySeedMeals() {
  const out = []
  const breakfasts = [
    ['Sorghum Porridge & Groundnuts', 470, 18, 58, 16, [
      ['Sorghum porridge', 220, '1 bowl'],
      ['Groundnuts', 35, 'small handful'],
      ['Honey', 15, '1 tsp'],
    ]],
    ['Sweet Potato & Egg Hash', 485, 32, 44, 18, [
      ['Sweet potato', 180, '1 medium'],
      ['Eggs', 150, '2 large'],
      ['Onion', 40, '¼ cup diced'],
    ]],
    ['Mabisi & Phala Bowl', 455, 22, 52, 14, [
      ['Mabisi', 200, '1 cup'],
      ['Maize phala', 80, '½ cup dry'],
      ['Banana', 100, '1 small'],
    ]],
    ['Tanganyika Sardine Omelette', 440, 34, 12, 28, [
      ['Eggs', 180, '3 large'],
      ['Titus sardines', 50, '½ tin drained'],
      ['Tomato', 60, '1 small'],
    ]],
    ['Pumpkin & Peanut Butter Oats', 475, 16, 62, 18, [
      ['Rolled oats', 70, '¾ cup dry'],
      ['Pumpkin', 120, '1 cup cubed'],
      ['Peanut butter', 25, '1 tbsp'],
    ]],
    ['Boiled Eggs & Nshima Cakes', 450, 28, 38, 16, [
      ['Eggs', 120, '2 large'],
      ['Nshima', 150, '1 small ball'],
      ['Rape leaves', 80, '1 cup'],
    ]],
    ['Chikanda & Tomato Relish', 430, 20, 48, 14, [
      ['Chikanda', 120, '2 slices'],
      ['Tomatoes', 100, '2 medium'],
      ['Sunflower oil', 8, '1 tsp'],
    ]],
    ['Millet & Dried Fish Breakfast', 465, 36, 42, 14, [
      ['Millet', 200, '1 bowl cooked'],
      ['Dried kapenta', 40, '3 tbsp'],
      ['Onion', 30, '2 tbsp'],
    ]],
    ['Avocado Egg Toast', 490, 26, 34, 28, [
      ['Whole wheat bread', 80, '2 slices'],
      ['Eggs', 120, '2 large'],
      ['Avocado', 90, '½ medium'],
    ]],
    ['Banana & Whey Phala', 460, 38, 48, 10, [
      ['Maize phala', 60, '½ cup dry'],
      ['Whey protein', 30, '1 scoop'],
      ['Banana', 120, '1 medium'],
    ]],
    ['Sweet Potato Pancakes', 475, 14, 68, 14, [
      ['Sweet potato', 200, '1 cup mashed'],
      ['Eggs', 60, '1 large'],
      ['Cinnamon', 2, 'pinch'],
    ]],
    ['Beef Liver & Onions', 445, 40, 18, 22, [
      ['Beef liver', 120, 'palm-sized'],
      ['Onion', 80, '1 medium'],
      ['Sunflower oil', 10, '1 tsp'],
    ]],
    ['Yoghurt & Granola Bowl', 455, 28, 52, 12, [
      ['Greek yoghurt', 180, '1 cup'],
      ['Granola', 45, '½ cup'],
      ['Berries', 60, '½ cup'],
    ]],
    ['Nshima & Fried Egg', 480, 22, 58, 16, [
      ['Nshima', 220, '2 small balls'],
      ['Eggs', 120, '2 fried'],
      ['Tomato', 50, '1 small'],
    ]],
    ['Groundnut Stew & Bread', 470, 18, 56, 18, [
      ['Groundnut stew', 200, '1 cup'],
      ['Whole wheat bread', 70, '2 slices'],
      ['Spinach', 60, '1 cup'],
    ]],
    ['Fish Cake & Greens', 450, 36, 32, 16, [
      ['Tilapia mince', 140, 'palm-sized'],
      ['Cabbage', 100, '1 cup'],
      ['Egg', 60, '1 binder'],
    ]],
    ['Cassava & Bean Mash', 465, 20, 62, 12, [
      ['Cassava', 180, '1 cup'],
      ['Black beans', 100, '½ cup'],
      ['Palm oil', 8, '1 tsp'],
    ]],
    ['Egg & Tomato Stew', 435, 30, 22, 24, [
      ['Eggs', 180, '3 large'],
      ['Tomatoes', 120, '2 medium'],
      ['Onion', 40, '¼ cup'],
    ]],
    ['Oat & Groundnut Porridge', 460, 16, 58, 16, [
      ['Rolled oats', 75, '¾ cup dry'],
      ['Groundnuts', 30, 'small handful'],
      ['Milk', 150, '1 cup'],
    ]],
    ['Sweet Potato & Kapenta Bowl', 475, 38, 48, 12, [
      ['Sweet potato', 200, '1 large'],
      ['Kapenta', 50, '½ cup'],
      ['Lemon', 10, 'squeeze'],
    ]],
  ]
  ...
  const lunches = [
    ['Grilled Bream & Nshima', 630, 54, 72, 12, [
      ['Bream fillet', 200, '1 fillet'],
      ['Nshima', 250, '2 balls'],
      ['Pumpkin leaves', 100, '1 cup'],
    ]],
    ['Chicken & Groundnut Stew', 610, 52, 48, 22, [
      ['Chicken thigh', 180, '1 piece skinless'],
      ['Groundnut paste', 30, '2 tbsp'],
      ['Nshima', 200, '2 balls'],
    ]],
    ['Beef Stew & Rice', 620, 48, 78, 14, [
      ['Lean beef', 180, 'palm-sized'],
      ['Rice', 220, '1 cup cooked'],
      ['Carrots', 80, '1 carrot'],
    ]],
    ['Tilapia & Sweet Potato', 600, 50, 58, 12, [
      ['Tilapia', 200, '1 fillet'],
      ['Sweet potato', 220, '1 large'],
      ['Green beans', 80, '1 cup'],
    ]],
    ['Bean & Nshima Bowl', 580, 36, 82, 8, [
      ['Borlotti beans', 220, '1 cup'],
      ['Nshima', 220, '2 balls'],
      ['Tomato', 80, '2 medium'],
    ]],
    ['Goat Stew & Greens', 615, 46, 42, 24, [
      ['Goat meat', 160, 'palm-sized'],
      ['Rape leaves', 120, '1½ cups'],
      ['Nshima', 200, '2 balls'],
    ]],
    ['Kapenta Relish Lunch', 590, 44, 70, 10, [
      ['Kapenta', 90, '¾ cup'],
      ['Nshima', 260, '2 balls'],
      ['Onion', 50, '¼ cup'],
    ]],
    ['Grilled Chicken Salad', 605, 56, 28, 22, [
      ['Chicken breast', 200, '1 breast'],
      ['Mixed salad', 150, '2 cups'],
      ['Olive oil', 12, '1 tbsp'],
    ]],
    ['Lentil & Vegetable Stew', 575, 32, 88, 10, [
      ['Lentils', 200, '1 cup cooked'],
      ['Nshima', 180, '2 small balls'],
      ['Spinach', 100, '1 cup'],
    ]],
    ['Pork & Cabbage Stir-fry', 610, 42, 52, 26, [
      ['Lean pork', 160, 'palm-sized'],
      ['Cabbage', 150, '2 cups'],
      ['Nshima', 180, '2 balls'],
    ]],
    ['Fish & Rice Pilaf', 595, 48, 72, 12, [
      ['Tilapia', 180, '1 fillet'],
      ['Rice', 240, '1¼ cups cooked'],
      ['Peas', 60, '½ cup'],
    ]],
    ['Chicken & Pumpkin Stew', 620, 50, 55, 18, [
      ['Chicken breast', 190, '1 breast'],
      ['Pumpkin', 200, '2 cups'],
      ['Nshima', 180, '2 balls'],
    ]],
    ['Beef & Sweet Potato Lunch', 615, 46, 62, 20, [
      ['Lean beef', 170, 'palm-sized'],
      ['Sweet potato', 240, '1 large'],
      ['Tomato', 70, '2 small'],
    ]],
    ['Egg & Nshima Lunch', 565, 34, 68, 14, [
      ['Eggs', 180, '3 large'],
      ['Nshima', 250, '2 balls'],
      ['Rape leaves', 90, '1 cup'],
    ]],
    ['Soya Chunks & Vegetables', 580, 40, 64, 12, [
      ['Soya chunks', 120, '1 cup rehydrated'],
      ['Nshima', 220, '2 balls'],
      ['Carrots', 70, '1 carrot'],
    ]],
    ['Tilapia & Cassava', 600, 52, 54, 14, [
      ['Tilapia', 200, '1 fillet'],
      ['Cassava', 220, '1 cup'],
      ['Lemon', 15, '1 tbsp juice'],
    ]],
    ['Chicken Gizzard Stew', 590, 48, 50, 18, [
      ['Chicken gizzards', 150, '1 cup'],
      ['Nshima', 230, '2 balls'],
      ['Onion', 60, '½ medium'],
    ]],
    ['Mince & Tomato Pasta', 625, 44, 82, 16, [
      ['Lean mince', 160, 'palm-sized'],
      ['Pasta', 220, '1 cup cooked'],
      ['Tomato sauce', 80, '½ cup'],
    ]],
    ['Grilled Fish & Beans', 605, 50, 60, 14, [
      ['Tilapia', 190, '1 fillet'],
      ['Beans', 180, '1 cup'],
      ['Onion', 50, '¼ cup'],
    ]],
    ['Beef & Spinach Wrap Bowl', 595, 46, 48, 22, [
      ['Lean beef', 160, 'palm-sized'],
      ['Spinach', 120, '1½ cups'],
      ['Nshima', 200, '2 balls'],
    ]],
    ['Chicken & Okra Stew', 610, 48, 58, 16, [
      ['Chicken breast', 185, '1 breast'],
      ['Okra', 100, '1 cup'],
      ['Nshima', 210, '2 balls'],
    ]],
    ['Dried Fish & Greens', 585, 42, 65, 12, [
      ['Dried fish', 70, '½ cup'],
      ['Nshima', 250, '2 balls'],
      ['Pumpkin leaves', 110, '1 cup'],
    ]],
  ]

  const dinners = [
    ['Grilled Chicken & Vegetables', 570, 48, 38, 20, [
      ['Chicken breast', 200, '1 breast'],
      ['Broccoli', 120, '1 cup'],
      ['Sweet potato', 150, '1 medium'],
    ]],
    ['Tilapia & Nshima Dinner', 560, 50, 58, 10, [
      ['Tilapia', 200, '1 fillet'],
      ['Nshima', 220, '2 balls'],
      ['Tomato', 80, '2 medium'],
    ]],
    ['Beef & Pumpkin Dinner', 575, 44, 42, 22, [
      ['Lean beef', 170, 'palm-sized'],
      ['Pumpkin', 220, '2 cups'],
      ['Onion', 50, '¼ cup'],
    ]],
    ['Egg & Vegetable Stir-fry', 540, 36, 28, 32, [
      ['Eggs', 180, '3 large'],
      ['Mixed vegetables', 200, '2 cups'],
      ['Sunflower oil', 12, '1 tbsp'],
    ]],
    ['Kapenta & Sweet Potato', 555, 42, 52, 14, [
      ['Kapenta', 80, '⅔ cup'],
      ['Sweet potato', 240, '1 large'],
      ['Lemon', 10, 'squeeze'],
    ]],
    ['Chicken & Cabbage Stew', 580, 46, 40, 20, [
      ['Chicken breast', 190, '1 breast'],
      ['Cabbage', 180, '2 cups'],
      ['Tomato', 70, '2 small'],
    ]],
    ['Bean & Sweet Potato Bowl', 545, 28, 68, 12, [
      ['Black beans', 200, '1 cup'],
      ['Sweet potato', 200, '1 large'],
      ['Spinach', 80, '1 cup'],
    ]],
    ['Grilled Beef & Salad', 590, 48, 22, 28, [
      ['Lean beef', 180, 'palm-sized'],
      ['Salad greens', 150, '2 cups'],
      ['Olive oil', 10, '1 tbsp'],
    ]],
    ['Fish & Greens Dinner', 565, 46, 35, 18, [
      ['Tilapia', 190, '1 fillet'],
      ['Rape leaves', 130, '1½ cups'],
      ['Garlic', 5, '1 clove'],
    ]],
    ['Chicken & Rice Dinner', 575, 50, 62, 14, [
      ['Chicken breast', 195, '1 breast'],
      ['Rice', 200, '1 cup cooked'],
      ['Peas', 70, '½ cup'],
    ]],
    ['Goat & Tomato Stew', 580, 42, 38, 26, [
      ['Goat meat', 165, 'palm-sized'],
      ['Tomatoes', 140, '3 medium'],
      ['Nshima', 150, '1 ball'],
    ]],
    ['Soya & Vegetable Curry', 550, 38, 52, 16, [
      ['Soya chunks', 130, '1 cup'],
      ['Mixed vegetables', 180, '2 cups'],
      ['Coconut milk', 60, '¼ cup light'],
    ]],
    ['Pork & Green Bean Dinner', 585, 40, 45, 24, [
      ['Lean pork', 165, 'palm-sized'],
      ['Green beans', 150, '1½ cups'],
      ['Nshima', 140, '1 ball'],
    ]],
    ['Tilapia & Cassava Dinner', 560, 48, 50, 12, [
      ['Tilapia', 195, '1 fillet'],
      ['Cassava', 210, '1 cup'],
      ['Chilli', 3, 'pinch'],
    ]],
    ['Chicken & Spinach Soup', 545, 44, 32, 22, [
      ['Chicken breast', 175, '1 breast'],
      ['Spinach', 140, '2 cups'],
      ['Stock', 120, '1 cup'],
    ]],
    ['Beef & Sweet Potato Mash', 575, 46, 48, 20, [
      ['Lean beef', 175, 'palm-sized'],
      ['Sweet potato', 230, '1 cup mash'],
      ['Butter', 8, '1 tsp'],
    ]],
    ['Egg & Nshima Dinner', 530, 32, 55, 16, [
      ['Eggs', 150, '2 large'],
      ['Nshima', 240, '2 balls'],
      ['Tomato', 60, '1 medium'],
    ]],
    ['Grilled Fish & Pumpkin', 565, 46, 44, 18, [
      ['Tilapia', 185, '1 fillet'],
      ['Pumpkin', 210, '2 cups'],
      ['Herbs', 5, 'pinch'],
    ]],
    ['Chicken & Mushroom Stew', 580, 48, 36, 22, [
      ['Chicken breast', 190, '1 breast'],
      ['Mushrooms', 120, '1 cup'],
      ['Onion', 55, '½ medium'],
    ]],
    ['Lentil & Tomato Dinner', 540, 30, 62, 14, [
      ['Lentils', 210, '1 cup cooked'],
      ['Tomatoes', 130, '3 medium'],
      ['Spinach', 90, '1 cup'],
    ]],
    ['Minced Beef & Vegetables', 570, 44, 40, 24, [
      ['Lean mince', 170, 'palm-sized'],
      ['Mixed vegetables', 190, '2 cups'],
      ['Tomato', 75, '2 small'],
    ]],
    ['Dried Fish & Sweet Potato', 555, 40, 54, 14, [
      ['Dried fish', 65, '½ cup'],
      ['Sweet potato', 250, '1 large'],
      ['Onion', 45, '¼ cup'],
    ]],
  ]

  for (const [name, cal, prot, carb, fat, ings] of breakfasts) {
    out.push(
      meal(
        'Breakfast',
        name,
        'Zambian breakfast for active fat loss.',
        cal,
        prot,
        carb,
        fat,
        ings.map(([ingredient, grams, measure]) => p(ingredient, grams, measure, ''))
      )
    )
  }
  for (const [name, cal, prot, carb, fat, ings] of lunches) {
    out.push(
      meal(
        'Lunch',
        name,
        'Zambian lunch with local staples.',
        cal,
        prot,
        carb,
        fat,
  ...
  for (const [name, cal, prot, carb, fat, ings] of dinners) {
    out.push(
      meal(
        'Dinner',
        name,
        'Zambian dinner — lean protein focus.',
        cal,
        prot,
        carb,
        fat,
...
export const zmLibrarySeedMeals = buildZmLibrarySeedMeals()
