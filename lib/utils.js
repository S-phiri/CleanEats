export const COUNTRIES = {
  ZM: { name:'Zambia', currency:'ZMW', sym:'K', label:'ZMW — Zambian Kwacha', budgetL:'K50–80/day', budgetM:'K120–200/day', budgetH:'K300+/day',
    ...
    note:'Major supermarkets in cities have good variety. Local shops and stalls often have the best-value fresh produce.' },
  ...
  NG: { name:'Nigeria', currency:'NGN', sym:'₦', label:'NGN — Nigerian Naira', budgetL:'₦3,000–5,000/day', budgetM:'₦8,000–15,000/day', budgetH:'₦25,000+/day',
    ...
    note:'Local shops and stalls often offer better value than large supermarkets.' },
...
export const TIERS = {
  free: { label: 'Free', creditsPerMonth: 10, planDays: 3 },
  pro:  { label: 'Pro',  creditsPerMonth: Infinity, planDays: 5 },
  coach:{ label: 'Coach', creditsPerMonth: Infinity, planDays: 7 },
}
